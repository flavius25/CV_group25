...
// 	vector <vector<float>> likelihoods; 
...
// 	vector <int> copyFL = final_labels; 
// 	sort(copyFL.begin(), copyFL.end());
// 	auto it = unique(copyFL.begin(), copyFL.end());
// 	if (it != copyFL.end()){
// 		cout << "Here";
// 	}
